        ...
        <div className="p-4 sm:p-6 rounded-lg border">
          ...
          <div className="flex flex-col sm:flex-row justify-between mb-8">
            ...
            <div className="flex flex-col items-start sm:items-end mt-4 sm:mt-0">
              ...
              >
                {orderDetails.isDelivered ? "Đã Vận Chuyển" : "Đang Vận Chuyển"}
              </span>
            </div>
          </div>
          ...
          <div className="overflow-x-auto">
            ...
            <div className="flex justify-between items-center text-xl font-semibold my-6 border-b pb-2">
              <p>Tổng Tiền</p>
              <p>{orderDetails.totalPrice?.toLocaleString()} ₫</p>
            </div>
          </div>
          {/* Back to Orders Link */}
