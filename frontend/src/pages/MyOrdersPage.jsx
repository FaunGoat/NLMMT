        ...
        <table className="min-w-full text-left text-gray-500">
          <thead className="bg-gray-100 text-xs uppercase text-gray-700">
            <tr>
              ...
              <th className="py-2 px-4 sm:py-3">Giá Tiền</th>
          ...
          <tbody>
            {orders.length > 0 ? (
              orders.map((order) => (
                ...
                >
                  <td className="py-2 px-2 sm:p-4 sm:px-4">
                    <img
                  ...
                  <td className="py-2 px-2 sm:p-4 sm:px-4 font-medium text-gray-900 whitespace-nowrap">
                    #{order._id}
                  </td>
                  <td className="py-2 px-2 sm:p-4 sm:px-4">
